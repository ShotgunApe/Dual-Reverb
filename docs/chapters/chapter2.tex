...
\begin{figure}[h] % [h] used to prevent {figure} from doing weird positioning
	...
	\begin{center}
		...
		\caption{A Model of a Audio Plugin Application.}
	\end{center}
\end{figure}
