...
As mentioned previously, M. R. Schroeder introduced some of the first algorithms to artificially reverberate a digital signal. Prior to this, there existed several methods of persisting sound with a short impulse. One such method was simply using a physical room. \textit{Echo Chambers}
